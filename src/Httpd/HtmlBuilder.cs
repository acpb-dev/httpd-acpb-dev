...
public static class HtmlBuilder
{
    ...
    public static string HelloJord()
    {
        return
            "<!doctype html> <html lang=\"en\"> <head> <meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" crossorigin=\"anonymous\"> <title>Debug Mode</title> </head> <body style=\"background-image: url('https://i.imgur.com/U3T88JT.jpg'); object-fit: cover; background-repeat: no-repeat; width: 100%; height: 100%;\"> <div class=\"container\"> <div class=\"jord\"> <h1>HELLO JORD, ma blonde fan de Lou, Lucy ET Skye</h1> </div> </div> <script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js\" crossorigin=\"anonymous\"></script> </body> </html>";
    }
    public static string HeaderDirectoryListing()
    {
        return "<!doctype html> <html lang=\"en\"> <head> <meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"> <link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" crossorigin=\"anonymous\"> <title>Directory Listing</title> </head> <body><div class=\"container\"> <h1>Directory Listing</h1> <div class=\"row\"> <div class=\"col-6\"> <h5> <a>Name</a> </h5> </div> <div class=\"col-4\"> <h5> <a>Last Modified</a> </h5> </div> <div class=\"col-2\"> <h5> <a>Size</a> </h5> </div> </div> <div class=\"row\">-----------------------------------------------------------------------------------------------------------------------------------------</div>";
    }
    public static string HeaderDebug()
    {
        return "<head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" crossorigin=\"anonymous\"><title>Debug Mode</title></head><body><div class=\"container\"><h1>Debug Mode</h1><div class=\"row\"><div class=\"col-6\"><h5><a>Key</a></h5></div><div class=\"col-6\"><h5><a>Value</a></h5></div></div><div class=\"row\">-----------------------------------------------------------------------------------------------------------------------------------------</div>";
    }
    public static string Footer()
    {
        return "</div><script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js\" crossorigin=\"anonymous\"></script></body></html>";
    }
    ...
    public static string Debug(IDictionary<string, string> request)
    {
        ...
        {
            html += $"<div class=\"row\" style=\"margin-top: .2rem;\"><div class=\"col-6\"><div><a>{key} :</a></div></div><div class=\"col-6\"><div><a style=\"word-wrap: break-word\">{value}</a></div></div></div>";
        }
        return html;
    }
}